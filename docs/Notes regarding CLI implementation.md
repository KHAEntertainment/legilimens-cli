...
3) deepwiki URL's are standardized. If the sourc eis github.com/vercel/ai-chatbot the deepwiki URL will be https://deepwiki.com/vercel/ai-chatbot. Shouldn't have to manually enter this if the system is finding the github repos for the user to begin with. 
